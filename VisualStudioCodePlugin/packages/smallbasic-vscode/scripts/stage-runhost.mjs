...
const hostRoot = path.join(repositoryRoot, "VisualStudioPlugin", "src", "SmallBasic.RunHost", "bin");
...
function findHost(targetFramework, fileName) {
  ...
  throw new Error(
    `${targetFramework}/${fileName} was not found. Build VisualStudioPlugin/src/SmallBasic.RunHost first.`
  );
}
