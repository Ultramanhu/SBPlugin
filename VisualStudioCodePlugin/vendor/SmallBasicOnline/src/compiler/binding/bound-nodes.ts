...
export class BoundEventAssignmentStatement extends BaseBoundStatement {
    public constructor(
        public readonly libraryName: string,
        public readonly eventName: string,
        public readonly subModuleName: string,
        syntax: BaseSyntaxNode) {
        super(BoundKind.EventAssignmentStatement, syntax);
    }
...
export class BoundLibraryEventExpression extends BaseBoundExpression {
    public constructor(
        public readonly libraryName: string,
        public readonly eventName: string,
        hasErrors: boolean,
        syntax: BaseSyntaxNode) {
        super(BoundKind.LibraryEventExpression, false, hasErrors, syntax);
    }
...
export class BoundNodeRewriter {
    public rewrite(node: BaseBoundNode): BaseBoundNode {
        switch (node.kind) {
            ...
            case BoundKind.LibraryEventExpression: return this.rewriteLibraryEventExpression(node as BoundLibraryEventExpression);
    ...
    public rewriteEventAssignmentStatement(node: BoundEventAssignmentStatement): BaseBoundNode {
        return node;
    }
    ...
    public rewriteLibraryEventExpression(node: BoundLibraryEventExpression): BaseBoundNode {
        return node;
    }
