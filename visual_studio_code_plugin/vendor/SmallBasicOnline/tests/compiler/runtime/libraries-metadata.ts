...
describe("Compiler.Runtime.LibrariesMetadata", () => {
    it("all libraries have correct metadata", () => {
        ...
        CompilerUtils.values(RuntimeLibraries.Metadata).forEach(library => {
            ...
            // The metadata documents the full Small Basic API surface (used by
            // completion, hover and diagnostics), while the runtime implements
            // a subset. Metadata-only libraries are checked for documentation
            // completeness only.
