...
#
#   Output 1 (VS Code):
#     VisualStudioCodePlugin/vendor/SmallBasicOnline/src/strings/documentation.locales.ts
#     - key spelling matches strings/documentation.ts (PascalCase parameter suffixes)
#
#   Output 2 (Visual Studio):
#     VisualStudioPlugin/vendor/SmallBasicEditor/Source/SmallBasic.Utilities/DocumentationLocales/DocumentationLocales.xml
...
$xmlDir = Join-Path $repoRoot 'SmallBasicRepo\SmallBasicHomeSite\src\assets\documentation\xml'
$resxPath = Join-Path $repoRoot 'VisualStudioPlugin\vendor\SmallBasicEditor\Source\SmallBasic.Utilities\Resources\LibrariesResources.resx'
$docTsPath = Join-Path $repoRoot 'VisualStudioCodePlugin\vendor\SmallBasicOnline\src\strings\documentation.ts'
$tsOutPath = Join-Path $repoRoot 'VisualStudioCodePlugin\vendor\SmallBasicOnline\src\strings\documentation.locales.ts'
$xmlOutPath = Join-Path $repoRoot 'VisualStudioPlugin\vendor\SmallBasicEditor\Source\SmallBasic.Utilities\DocumentationLocales\DocumentationLocales.xml'
...
$tsLines.Add('// SmallBasicRepo/SmallBasicHomeSite/src/assets/documentation/xml/SmallBasicLibrary.*.xml.')
...
[void]$sb.AppendLine('     SmallBasicRepo/SmallBasicHomeSite/src/assets/documentation/xml/SmallBasicLibrary.*.xml. -->')
